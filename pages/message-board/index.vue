<template>
    <div class="w-[1024px] h-[700px] mt-20 bg-slate-50 dark:bg-slate-700 rounded-lg md:rounded-xl mx-3 lg:mx-0 shadow-lg md:shadow-xl p-3 xs:p-6 md:p-9">
        ...
        <div class="space-y-4">
            <div> 
                ...
                <p class="text-gray-800 py-3">这是留言内容...</p>
